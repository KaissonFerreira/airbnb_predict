...
Welcome to ``airbnb_predict`` contributor's guide.
...
If you experience bugs or general issues with ``airbnb_predict``, please have a look
...
You can help improve ``airbnb_predict`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``airbnb_predict`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``airbnb_predict``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n airbnb_predict python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/airbnb_predict.git
    cd airbnb_predict
...
#. Install |pre-commit|_::
   ...
   ``airbnb_predict`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/airbnb_predict
.. _issue tracker: https://github.com/<USERNAME>/airbnb_predict/issues
.. <-- end -->
